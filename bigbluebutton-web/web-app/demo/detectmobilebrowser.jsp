...
public String mobileRedirect(String joinURL) {
  String url = joinURL.replace("http://", "bigbluebutton://");

  String script =  "<script language=\"javascript\" type=\"text/javascript\"> \n";
         script += "// we don't do a simple location.href because the browser would show this jsp page (empty page) \n";
         script += "window.setTimeout(function () { window.location.href=\"" + url + "\" }, 0) // open the app \n";
         script += "window.location.href=\"/\";                                                // browser goes back to root \n";
         script += "</script>";
